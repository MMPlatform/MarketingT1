...
<!--my--><!--my	
 ...
 -->
			...
			gettitle=document.getElementById('wc-panel-twitter').url.value;
			getimg=document.getElementById('wc-panel-feed').url.value;
			if (myurl!==""){window.location.href='#feed:'+myurl; }
			if (baike!==""){window.location.href='#feed:http://baike.baidu.com/search/word?word='+baike; }
			if (gettitle!==""){loadImages(true);}
			if (getimg!==""){document.getElementById('mymyimg').style.display="block";myloadImages(true);}
			}
			</script>
<!--my-->
</head>
...
<!--my-->
          <form id="wc-panel-twitter" hidden>
           <div id="loadImagesSection">
        
       
        <div class="container" style="text-align: center;">
          <div class="row-fluid" style="margin-bottom: 30px;">
            <img id="myimg" class="span4 img-rounded" data-img="1" style="height: 187px;" src="img/ok.jpg"  />
			
		  </div>
          </div>
			<input type="text" value=""  id="myresult" name="myresult" style="display:none" />
          <input type="text" value=""   name="url"/><br>
      </div>
...
<!--myimg-->
          <form id="wc-panel-feed" hidden  >
			...
			<div id="myloadImagesSection">
        
				<div class="container" style="text-align: center;">
				  <div class="row-fluid" style="margin-bottom: 30px; text-align:left;">
					<img id="mymyimg" class="span4 img-rounded" data-img="1" style="height: 187px;" src="img/ok.jpg"  />
					<input type="text" value=""  id="mymyresult" name="mymyresult" style="display:none;border:0;solid #999;height:187px;width:300px;font-size:36px; background:#ffffff; line-height:187px; margin:0px; padding:0px; " />
				  </div>
				  </div>
...
<!--my-->
 ...
 <script type="text/javascript">
			...
			document.getElementById('wc-panel-feed').url.value="";
</script>
</body>
