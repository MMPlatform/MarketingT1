...
(function(a) {
    a.fn.fullpage = function(c) {
        ...
        a.fn.fullpage.setMouseWheelScrolling = function(a) {
            a ? document.addEventListener ? (document.addEventListener("mousewheel", p, !1), document.addEventListener("wheel", p, !1)) : document.attachEvent("onmousewheel", p) : document.addEventListener ? (document.removeEventListener("mousewheel", p, !1), document.removeEventListener("wheel", p, !1)) : document.detachEvent("onmousewheel",
                p)
        };
        ...
        a(".fp-section").each(function(b) {
            ...
            if (1 < f) {
                ...
                a(this).find(".fp-slides").after('<div class="fp-controlArrow fp-prev"><img src="img/btn_lastpage.png" style="position:absolute;"></div><div class="fp-controlArrow fp-next"><img src="img/btn_nextpage.png" style="position:absolute;left:-57px;"></div>');
            ...
            c.navigation && (x.css("margin-top", "-" + x.height()*5 / 3 + "px"), x.find("li").eq(a(".fp-section.active").index(".fp-section")).find("a").addClass("active"));
